...
public sealed partial class Plugin
{
    ...
    // archive/verdict paths. RUN-scoped in the strict sense: cleared in Plugin.RunBoundary.cs's
    // BankRunBoundary (a true run/scene boundary only), NOT in ResetRunScopedTrackers beside _seenSummons —
    // that also runs on a mid-run RunSegmentCut, and a pet alive across a boss cut must keep its owner.
